...
- `rezultati_sabor_2024/{2024,2020,2016,2015}/CSV/` — 51 CSV files per year (11 districts × 3 file types + 6 district 12 files × 3, minus district 11's missing inozemstvo file); 2016 and 2015 have 50, also missing district 11's posebna/inozemstvo pairing. Parent folder kept its original 2024-only name. 2016 uses a swapped filename convention (see sabor.py note above). 2016/2015 also ship the source `Excel/` alongside `CSV/`.
