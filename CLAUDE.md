...
- `rezultati_sabor_2024/{2024,2020}/CSV/` — 51 CSV files per year (11 districts × 3 file types + 6 district 12 files × 3); parent folder kept its original 2024-only name
