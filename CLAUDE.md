...
- `rezultati_sabor_2024/{2024,2020,2016}/CSV/` — 51 CSV files per year (11 districts × 3 file types + 6 district 12 files × 3, minus district 11's missing inozemstvo file); parent folder kept its original 2024-only name. 2016 uses a swapped filename convention (see sabor.py note above).
